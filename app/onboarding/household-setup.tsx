...
import { Thermometer, Activity, Car, Moon, Pill } from 'lucide-react-native';
...
function ResourceToggle({ label, icon, value, onValueChange }: ResourceToggleProps) {
  return (
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            We adjust our recommendations based on what you have at home right now.
          </Text>
        </View>
        ...
        <Card variant="elevated" style={styles.pharmacyCard}>
          ...
          <View style={styles.distanceRow}>
            <Text style={styles.distanceValue}>1.5 <Text style={styles.unit}>km</Text></Text>
          </View>
