...
const STATE_URGENT = {
  ...
  explanation: 'Condition has worsened significantly. Immediate medical attention is required.',
};
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.header}>
          <AlertCircle size={80} color={COLORS.state.urgent.primary} strokeWidth={2.5} />
