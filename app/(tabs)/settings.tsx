...
import { ScrollView, StyleSheet, Text, View, Pressable, Switch, Alert } from 'react-native';
import { Stack } from 'expo-router';
import { useSafeAreaInsets } from 'react-native-safe-area-context';
import { User, Bell, Languages, Database, Info, ChevronRight, Download, Trash2, ShieldCheck } from 'lucide-react-native';
...
function SettingsRow({ label, icon, children, onPress, showChevron = true, destructive = false }: SettingsRowProps) {
  return (
    <Pressable 
      onPress={onPress}
      style={({ pressed }) => [
    ...
    >
      ...
      <View style={styles.rowContent}>
        {children}
        {showChevron && !children && <ChevronRight size={20} color={COLORS.textSecondary} />}
      </View>
    </Pressable>
  );
}
  ...
  const handleClearData = () => {
    Alert.alert(
      ...
      [
        ...
        { text: "Delete Everything", style: "destructive", onPress: () => console.log("Data cleared") }
      ]
    );
  };
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.aboutSection}>
          <Text style={styles.versionText}>HomePulse v1.0.0 (Hackathon Build)</Text>
          ...
          <View style={styles.disclaimerBox}>
            ...
            <Text style={styles.disclaimerText}>
              This app is a decision support tool and does not provide medical diagnosis.
            </Text>
          </View>
        </View>
      </ScrollView>
