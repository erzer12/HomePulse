...
const MOCK_REASONING = {
	...
	reasoning:
		"The high temperature combined with the duration of the fever suggests active management is needed. While Rohan is currently hydrated, the lethargy requires consistent monitoring to ensure the body is managing the infection effectively.",
	careSteps: [
		...
		<View style={[styles.container, { paddingTop: insets.top }]}>
			...
			<ScrollView contentContainerStyle={styles.scrollContent}>
				...
				<View
					style={[
						styles.statusBanner,
						{ backgroundColor: MOCK_REASONING.state.theme.surface },
					]}
				>
					<View
						style={[
							styles.statusDot,
							{ backgroundColor: MOCK_REASONING.state.theme.primary },
						]}
					/>
					<Text
						style={[
							styles.statusText,
							{ color: MOCK_REASONING.state.theme.text },
						]}
					>
				...
				<View style={styles.section}>
					...
					<Card style={[styles.contentCard, styles.urgentCard]}>
						{MOCK_REASONING.triggers.map((trigger) => (
