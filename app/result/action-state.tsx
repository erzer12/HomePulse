...
import { CheckCircle2, Clock, Share2, ChevronRight } from 'lucide-react-native';
...
const MOCK_RESULT = {
  state: {
    ...
    explanation: 'Rohan\'s symptoms require active management at home. Follow the care steps below and recheck in 4 hours.',
  },
  nextSteps: [
    { id: '1', title: 'Administer Paracetamol (as per weight)', icon: <CheckCircle2 size={20} color={COLORS.state.care.primary} /> },
    { id: '2', title: 'Ensure frequent sips of ORS or water', icon: <CheckCircle2 size={20} color={COLORS.state.care.primary} /> },
    { id: '3', title: 'Keep room well-ventilated and cool', icon: <CheckCircle2 size={20} color={COLORS.state.care.primary} /> },
  ],
    ...
    <View style={styles.container}>
      <Stack.Screen 
        options={{ 
          ...
          headerRight: () => (
            <Share2 size={24} color={COLORS.primary} style={{ marginRight: SPACING.md }} />
          )
        }} 
      />
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.recheckCard}>
          ...
          <Text style={styles.recheckText}>
            Recheck condition in <Text style={styles.bold}>{MOCK_RESULT.recheckInterval}</Text>
          </Text>
        </View>
